...
The US Disease Tracker project provides consolidated epidemiologically sound data, analytics, and insights for monitoring and responding to disease threats across the United States.
...
Navigate through the documentation using the sidebar menu to learn about:

- **Data Submission** - How to submit data to the tracker
- **Technical Specifications** - Detailed field specifications and requirements
- **Data Transfer** - Technical methods for data transfer
- **Validation Rules** - Data validation requirements
- **Templates & Examples** - Working templates and example files

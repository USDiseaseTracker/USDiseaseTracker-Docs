...
| disease_subtype | String | Disease subtype (meningococcal serogroup) | `A`, `B`, `C`, `W`, `X`, `Y`, `Z`, `nongroupable`, `total`, `unknown`, `unspecified` | Yes |
<br>
...
| perinatal hepatitis b | `<2 y`, `total` | only &lt;2yrs |

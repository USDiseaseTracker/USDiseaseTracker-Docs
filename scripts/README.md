...
This script validates that the technical specifications in `webpage/_guides/data-technical-specs.md` and the data dictionary in `examples-and-templates/disease_tracking_data_dictionary.csv` match the JSON schema in `examples-and-templates/data_reporting_schema.json`.

...
- `disease_tracking_report_CA-EXAMPLE_2026-02-09.csv` - Sample data file with measles and pertussis data from California state, demonstrating proper format and structure
